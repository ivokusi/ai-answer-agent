export class Logger {
    ...
    private formatLogLevel(level: string) {
    ...
    info(message: string, data?: any) {
        ...
        console.log(
            this.colorize("blue", this.formatLogLevel("info")) + " " + this.formatOutput(formattedData)
        )
    }
    ...
    error(message: string, error?: Error | unknown, data?: any) {
        ...
        console.error(
            this.colorize("red", this.formatLogLevel("error")) + " " + this.formatOutput(formattedData)
        );
    }
    ...
    warn(message: string, data?: any) {
        ...
        console.warn(
            this.colorize("yellow", this.formatLogLevel("warn")) + " " + this.formatOutput(formattedData)
        );
    }
    ...
    debug(message: string, data?: any) {
        if (process.env.NODE_ENV !== "development") {
            ...
            console.debug(
                this.colorize("gray", this.formatLogLevel("debug")) + " " + this.formatOutput(formattedData)
            );
        }
    }
